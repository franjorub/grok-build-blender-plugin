...
3. **Blender** running with the official Lab **MCP add-on** installed and enabled:
   ...
   - **Plugin version = MCPB version.** This plugin **1.0.0** pins the server to Lab git tag **`v1.0.0`** ([releases](https://projects.blender.org/lab/blender_mcp/releases)). Use a matching MCP add-on version in Blender.
